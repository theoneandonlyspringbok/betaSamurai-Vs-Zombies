ӁShader "Griptonite/TwoSpecularBlendLitBumpmap" {
Properties {
...
void main ()
{
  ...
  c1 = tmpvar_6;
  lowp vec4 tmpvar_7;
  tmpvar_7 = texture2D (_SecondTex, tmpvar_2);
  highp vec4 tmpvar_8;
  tmpvar_8 = (tmpvar_7 * _SecondColor);
  c2 = tmpvar_8;
  lowp vec3 tmpvar_9;
  tmpvar_9 = ((texture2D (_BumpMap, tmpvar_3).xyz * 2.0) - 1.0);
  highp vec4 tmpvar_10;
  tmpvar_10 = (c1 * tmpvar_1.w);
  c_i0 = tmpvar_10;
  highp vec4 tmpvar_11;
  tmpvar_11 = (c_i0 + (c2 * (1.0 - tmpvar_1.w)));
  c_i0 = tmpvar_11;
  highp vec3 tmpvar_12;
  tmpvar_12 = (c_i0.xyz * (tmpvar_1.xyz * _ColorIntensity));
  c_i0.xyz = tmpvar_12;
  ...
  tmpvar_15 = max (0.0, dot (tmpvar_9, lightDir));
  mediump float tmpvar_16;
  tmpvar_16 = max (0.0, dot (tmpvar_9, normalize ((lightDir + viewDir))));
  nh = tmpvar_16;
...
void main ()
{
  ...
  highp vec4 tmpvar_5;
  tmpvar_5 = (tmpvar_4 * _MainColor);
  c1 = tmpvar_5;
  lowp vec4 tmpvar_6;
  tmpvar_6 = texture2D (_SecondTex, tmpvar_2);
  highp vec4 tmpvar_7;
  tmpvar_7 = (tmpvar_6 * _SecondColor);
  c2 = tmpvar_7;
  highp vec4 tmpvar_8;
  tmpvar_8 = (c1 * tmpvar_1.w);
  c_i0 = tmpvar_8;
  highp vec4 tmpvar_9;
  tmpvar_9 = (c_i0 + (c2 * (1.0 - tmpvar_1.w)));
  c_i0 = tmpvar_9;
  highp vec3 tmpvar_10;
  tmpvar_10 = (c_i0.xyz * (tmpvar_1.xyz * _ColorIntensity));
  c_i0.xyz = tmpvar_10;
...
void main ()
{
  ...
  highp float nh;
  mediump float tmpvar_16;
  tmpvar_16 = max (0.0, dot (tmpvar_9, lightDir));
  mediump float tmpvar_17;
  tmpvar_17 = max (0.0, dot (tmpvar_9, normalize ((lightDir + viewDir))));
  nh = tmpvar_17;
...
void main ()
{
  ...
  tmpvar_15 = vec2(dot (xlv_TEXCOORD3, xlv_TEXCOORD3));
  lowp vec4 tmpvar_16;
  tmpvar_16 = texture2D (_LightTexture0, tmpvar_15);
  ...
  highp float nh;
  mediump float tmpvar_17;
  tmpvar_17 = max (0.0, dot (tmpvar_9, lightDir_i0));
  mediump float tmpvar_18;
  tmpvar_18 = max (0.0, dot (tmpvar_9, normalize ((lightDir_i0 + normalize (xlv_TEXCOORD2)))));
  nh = tmpvar_18;
  highp vec3 tmpvar_19;
  tmpvar_19 = ((((tmpvar_4 * _LightColor0.xyz) * tmpvar_17) + (_LightColor0.xyz * pow (nh, _SpecStrength))) * (atten * 2.0));
  c_i0_i1.xyz = tmpvar_19;
  c_i0_i1.w = 0.0;
  c = c_i0_i1;
  c.w = 0.0;
  gl_FragData[0] = c;
...
void main ()
{
  ...
  tmpvar_14 = max (0.0, dot (tmpvar_9, lightDir_i0));
  mediump float tmpvar_15;
  tmpvar_15 = max (0.0, dot (tmpvar_9, normalize ((lightDir_i0 + normalize (xlv_TEXCOORD2)))));
  nh = tmpvar_15;
  highp vec3 tmpvar_16;
  tmpvar_16 = ((((tmpvar_4 * _LightColor0.xyz) * tmpvar_14) + (_LightColor0.xyz * pow (nh, _SpecStrength))) * 2.0);
...
void main ()
{
  ...
  lightDir_i0 = lightDir;
  mediump float atten;
  atten = ((float((xlv_TEXCOORD3.z > 0.0)) * tmpvar_15.w) * tmpvar_17.w);
  mediump vec4 c_i0_i1;
  highp float nh;
  mediump float tmpvar_18;
  tmpvar_18 = max (0.0, dot (tmpvar_9, lightDir_i0));
  mediump float tmpvar_19;
  tmpvar_19 = max (0.0, dot (tmpvar_9, normalize ((lightDir_i0 + normalize (xlv_TEXCOORD2)))));
  nh = tmpvar_19;
  highp vec3 tmpvar_20;
  tmpvar_20 = ((((tmpvar_4 * _LightColor0.xyz) * tmpvar_18) + (_LightColor0.xyz * pow (nh, _SpecStrength))) * (atten * 2.0));
  c_i0_i1.xyz = tmpvar_20;
  c_i0_i1.w = 0.0;
  c = c_i0_i1;
  c.w = 0.0;
  gl_FragData[0] = c;
...
void main ()
{
  ...
  highp float nh;
  mediump float tmpvar_15;
  tmpvar_15 = max (0.0, dot (tmpvar_9, lightDir_i0));
  mediump float tmpvar_16;
  tmpvar_16 = max (0.0, dot (tmpvar_9, normalize ((lightDir_i0 + normalize (xlv_TEXCOORD2)))));
  nh = tmpvar_16;
  highp vec3 tmpvar_17;
