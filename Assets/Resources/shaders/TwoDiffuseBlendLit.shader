—¿Shader "Griptonite/TwoDiffuseBlendLit" {
Properties {
...
void main ()
{
  ...
  highp vec4 tmpvar_4;
  tmpvar_4 = (tmpvar_3 * _MainColor);
  c1 = tmpvar_4;
  lowp vec4 tmpvar_5;
  tmpvar_5 = texture2D (_SecondTex, xlv_TEXCOORD0);
  highp vec4 tmpvar_6;
  tmpvar_6 = (tmpvar_5 * _SecondColor);
  c2 = tmpvar_6;
  highp vec4 tmpvar_7;
  tmpvar_7 = (c1 * tmpvar_1.w);
  c_i0 = tmpvar_7;
  highp vec4 tmpvar_8;
  tmpvar_8 = (c_i0 + (c2 * (1.0 - tmpvar_1.w)));
  c_i0 = tmpvar_8;
  highp vec3 tmpvar_9;
  tmpvar_9 = (c_i0.xyz * (tmpvar_1.xyz * _ColorIntensity));
  c_i0.xyz = tmpvar_9;
  ...
  c_i0_i1.xyz = ((tmpvar_2 * _LightColor0.xyz) * (dot (xlv_TEXCOORD1, lightDir) * 2.0));
  c_i0_i1.w = 0.0;
  c = c_i0_i1;
...
void main ()
{
  ...
  atten_i0 = tmpvar_11;
  mediump vec4 c_i0_i1;
  c_i0_i1.xyz = ((tmpvar_2 * _LightColor0.xyz) * ((dot (xlv_TEXCOORD1, lightDir) * atten_i0) * 2.0));
  c_i0_i1.w = 0.0;
  c = c_i0_i1;
  c.xyz = (c.xyz + (tmpvar_2 * xlv_TEXCOORD2));
  gl_FragData[0] = c;
...
void main ()
{
  ...
  atten = tmpvar_13.w;
  mediump vec4 c_i0_i1;
  c_i0_i1.xyz = ((tmpvar_2 * _LightColor0.xyz) * ((dot (xlv_TEXCOORD1, lightDir_i0) * atten) * 2.0));
  c_i0_i1.w = 0.0;
  c = c_i0_i1;
  c.w = 0.0;
  gl_FragData[0] = c;
...
void main ()
{
  ...
  lightDir_i0 = lightDir;
  mediump vec4 c_i0_i1;
  c_i0_i1.xyz = ((tmpvar_2 * _LightColor0.xyz) * (dot (xlv_TEXCOORD1, lightDir_i0) * 2.0));
  c_i0_i1.w = 0.0;
  c = c_i0_i1;
  c.w = 0.0;
  gl_FragData[0] = c;
...
void main ()
{
  ...
  lightDir_i0 = lightDir;
  mediump float atten;
  atten = ((float((xlv_TEXCOORD3.z > 0.0)) * tmpvar_12.w) * tmpvar_14.w);
  mediump vec4 c_i0_i1;
  c_i0_i1.xyz = ((tmpvar_2 * _LightColor0.xyz) * ((dot (xlv_TEXCOORD1, lightDir_i0) * atten) * 2.0));
  c_i0_i1.w = 0.0;
  c = c_i0_i1;
