ՖShader "Griptonite/DiffuseWithColorIntensity" {
Properties {
...
uniform lowp float _ColorIntensity;
void main ()
{
  lowp vec4 c;
  lowp vec4 tmpvar_1;
  tmpvar_1 = ((texture2D (_MainTex, xlv_TEXCOORD0) * (1.0 - _ColorIntensity)) + (_MainColor * _ColorIntensity));
  lowp vec4 c_i0_i1;
