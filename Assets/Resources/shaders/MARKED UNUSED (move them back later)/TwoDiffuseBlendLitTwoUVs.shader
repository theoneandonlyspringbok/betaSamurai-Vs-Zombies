¸ÖShader "Griptonite/TwoDiffuseBlendLitTwoUVs" {
Properties {
...
void main ()
{
  ...
  tmpvar_1.zw = ((_glesMultiTexCoord0.xy * _SecondTex_ST.xy) + _SecondTex_ST.zw);
  mat3 tmpvar_4;
...
void main ()
{
  ...
  c1 = tmpvar_6;
  lowp vec4 tmpvar_7;
  tmpvar_7 = texture2D (_SecondTex, tmpvar_3);
  highp vec4 tmpvar_8;
  tmpvar_8 = (tmpvar_7 * _SecondColor);
  c2 = tmpvar_8;
  highp vec4 tmpvar_9;
  tmpvar_9 = (c1 * tmpvar_1.w);
  c_i0 = tmpvar_9;
  highp vec4 tmpvar_10;
  tmpvar_10 = (c_i0 + (c2 * (1.0 - tmpvar_1.w)));
  c_i0 = tmpvar_10;
  highp vec3 tmpvar_11;
  tmpvar_11 = (c_i0.xyz * (tmpvar_1.xyz * _ColorIntensity));
  c_i0.xyz = tmpvar_11;
  ...
  c_i0_i1.xyz = ((tmpvar_4 * _LightColor0.xyz) * (dot (xlv_TEXCOORD1, lightDir) * 2.0));
  c_i0_i1.w = 0.0;
  c = c_i0_i1;
...
void main ()
{
  ...
  c.xyz = (tmpvar_4 * (2.0 * texture2D (unity_Lightmap, xlv_TEXCOORD1).xyz));
  c.w = 0.0;
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  atten_i0 = tmpvar_13;
  mediump vec4 c_i0_i1;
  c_i0_i1.xyz = ((tmpvar_4 * _LightColor0.xyz) * ((dot (xlv_TEXCOORD1, lightDir) * atten_i0) * 2.0));
  c_i0_i1.w = 0.0;
  c = c_i0_i1;
  c.xyz = (c.xyz + (tmpvar_4 * xlv_TEXCOORD2));
  gl_FragData[0] = c;
...
void main ()
{
  ...
  tmpvar_4 = tmpvar_12;
  c = vec4(0.0, 0.0, 0.0, 0.0);
  c.xyz = (tmpvar_4 * min ((2.0 * texture2D (unity_Lightmap, xlv_TEXCOORD1).xyz), vec3((texture2DProj (_ShadowMapTexture, xlv_TEXCOORD2).x * 2.0))));
  c.w = 0.0;
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  atten = tmpvar_15.w;
  mediump vec4 c_i0_i1;
  c_i0_i1.xyz = ((tmpvar_4 * _LightColor0.xyz) * ((dot (xlv_TEXCOORD1, lightDir_i0) * atten) * 2.0));
  c_i0_i1.w = 0.0;
  c = c_i0_i1;
  c.w = 0.0;
  gl_FragData[0] = c;
...
void main ()
{
  ...
  lightDir_i0 = lightDir;
  mediump vec4 c_i0_i1;
  c_i0_i1.xyz = ((tmpvar_4 * _LightColor0.xyz) * (dot (xlv_TEXCOORD1, lightDir_i0) * 2.0));
  c_i0_i1.w = 0.0;
  c = c_i0_i1;
  c.w = 0.0;
  gl_FragData[0] = c;
