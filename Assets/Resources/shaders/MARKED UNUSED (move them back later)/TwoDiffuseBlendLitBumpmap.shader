°€Shader "Griptonite/TwoDiffuseBlendLitBumpmap" {
Properties {
...
void main ()
{
  ...
  c_i0_i1.xyz = ((tmpvar_4 * _LightColor0.xyz) * (dot (tmpvar_9, lightDir) * 2.0));
  c_i0_i1.w = 0.0;
  c = c_i0_i1;
  c.xyz = (c.xyz + (tmpvar_4 * xlv_TEXCOORD2));
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  atten_i0 = tmpvar_14;
  mediump vec4 c_i0_i1;
  c_i0_i1.xyz = ((tmpvar_4 * _LightColor0.xyz) * ((dot (tmpvar_9, lightDir) * atten_i0) * 2.0));
  c_i0_i1.w = 0.0;
  c = c_i0_i1;
  c.xyz = (c.xyz + (tmpvar_4 * xlv_TEXCOORD2));
  gl_FragData[0] = c;
...
void main ()
{
  ...
  tmpvar_15 = vec2(dot (xlv_TEXCOORD2, xlv_TEXCOORD2));
  lowp vec4 tmpvar_16;
  ...
  atten = tmpvar_16.w;
  mediump vec4 c_i0_i1;
  c_i0_i1.xyz = ((tmpvar_4 * _LightColor0.xyz) * ((dot (tmpvar_9, lightDir_i0) * atten) * 2.0));
  c_i0_i1.w = 0.0;
  c = c_i0_i1;
  c.w = 0.0;
  gl_FragData[0] = c;
...
void main ()
{
  ...
  lightDir_i0 = lightDir;
  mediump vec4 c_i0_i1;
  c_i0_i1.xyz = ((tmpvar_4 * _LightColor0.xyz) * (dot (tmpvar_9, lightDir_i0) * 2.0));
  c_i0_i1.w = 0.0;
  c = c_i0_i1;
  c.w = 0.0;
  gl_FragData[0] = c;
...
void main ()
{
  ...
  lightDir = tmpvar_14;
  lowp vec4 tmpvar_15;
  tmpvar_15 = texture2D (_LightTexture0, ((xlv_TEXCOORD2.xy / xlv_TEXCOORD2.w) + 0.5));
  ...
  lightDir_i0 = lightDir;
  mediump float atten;
  atten = ((float((xlv_TEXCOORD2.z > 0.0)) * tmpvar_15.w) * tmpvar_17.w);
  mediump vec4 c_i0_i1;
  c_i0_i1.xyz = ((tmpvar_4 * _LightColor0.xyz) * ((dot (tmpvar_9, lightDir_i0) * atten) * 2.0));
  c_i0_i1.w = 0.0;
  c = c_i0_i1;
...
void main ()
{
  ...
  lowp vec4 tmpvar_17;
  tmpvar_17 = textureCube (_LightTexture0, xlv_TEXCOORD2);
  mediump vec3 lightDir_i0;
  lightDir_i0 = lightDir;
  mediump float atten;
...
void main ()
{
  ...
  lightDir = xlv_TEXCOORD1;
  lowp vec4 tmpvar_14;
  tmpvar_14 = texture2D (_LightTexture0, xlv_TEXCOORD2);
  mediump vec3 lightDir_i0;
  lightDir_i0 = lightDir;
  mediump float atten;
  atten = tmpvar_14.w;
